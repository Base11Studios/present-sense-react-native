  ...
  render() {
    ...
    return (
      <ScrollingPageContainer style={styles.header}>
        ...
        <MyText style={{ marginBottom: 24 }}>
          Have you ever tried to start up a mindfulness practice and had trouble
          creating a routine? Or are you consistently meditating but looking for
          more ways to bring mindfulness into your life? Mindful journaling
          helps us vocalize our feelings and notice the benefits of being
          present. By writing down how we feel after a mindful experience, we're
          creating a habit and training ourselves to pay attention in everyday
          life.
        </MyText>
        <Title3>How often should I do Mindful Experiences?</Title3>
        <MyText style={{ marginBottom: 24 }}>
          Everyday, all the time! As you focus on the present, your brain
          actually starts to change. Are there things you don't like doing, such
          as cleaning the dishes or sitting in meetings? Or are there things you
          do everyday that you don't think about, like brushing your teeth or
          driving to work? If you actually bring your focus to that activity and
          pair it with some deep breathing, you can change your perception of
          the activity and actually enjoy your time doing it. Think of every
          moment and every activity you do as a chance to practice mindfulness.
        </MyText>
