export const quoteData = [
  ...
  {
    quote: '"Whereever you go, there you are."',
    author: 'Jon Kabat-Zinn'
  },
  {
  ...
  {
    quote: '"When you are present, you can allow the mind to be as it is without getting entangled in it."',
  ...
  {
    quote: '"Mindfulness, the Root of Happiness."',
  ...
  {
    quote: '"Use every distraction as an object of meditation and they cease to be distractions."',
  ...
  {
    quote: '"As soon as we wish to be happier, we are no longer happy"',
  ...
  {
    quote: '"It is never too late to turn on the light."',
  ...
  {
    quote: '"We cannot force the development of mindfulness."',
    author: 'Allen Lokos'
  },
  {
  ...
  {
    quote: '"The mind is just like a muscle – the more you exercise it, the stronger it gets and the more it can expand."',
  ...
  {
    quote: '"Open the window of your mind. Allow the fresh air, new lights and new truths to enter."',
    author: 'Amit Ray'
  },
  {
  ...
  {
    quote: '"Each place is the right place--the place where I now am can be a sacred space."',
  ...
  {
    quote: '"Every time we become aware of a thought, as opposed to being lost in a thought, we experience that opening of the mind."',
    author: 'Joseph Goldstein'
  },
  {
  ...
  {
    quote: '"The real meditation is how you live your life."',
    author: 'Jon Kabat-Zinn'
  },
  {
  ...
  {
    quote: '"What day is it?" asked Pooh. "It\'s today," squeaked Piglet. "My favourite day," said Pooh.',
    author: 'A. A. Milne'
  },
];
