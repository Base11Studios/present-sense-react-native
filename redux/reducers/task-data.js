...
export const taskData = [
  ...
  },
  {
    ...
    type: 'Anytime',
    description:
      'There are many formal mindfulness meditation practices you can follow. Choose your favorite one, find a quiet place, and start meditating.',
    focusType: 'Mind',
    applicableFocusTypes: ['Mind'],
    prompt: 'What did you notice?',
    mindPrompt: 'What did you notice?',
    hints:
      "If you don't already have a meditation, try this for 10 minutes: Sit comfortably in a chair, close your eyes, and focus on your breath. Observe the parts of your body that move when you breathe in, and those that move when you breathe out. Focus on the nostrils, chest, or stomach. When your mind wanders, bring your attention back to the breath.",
    premium: false,
    count: 0
  },
  {
  ...
  {
    title: 'Daily intention journaling',
    id: '16',
    type: 'Morning',
    description:
    ...
    focusType: 'Mind',
    applicableFocusTypes: ['Mind'],
    prompt: 'What did you notice with your intention today?',
    mindPrompt: 'What did you notice with your intention today?',
    hints:
