...
export class BackButton extends React.Component {
  render() {
    return (
      <TouchableOpacity onPress={() => this.props.navigation.dispatch(NavigationActions.back())} style={{ flex: 1 }} activeOpacity={0.9}>
        <View
          style={{
            width: 40,
            height: 40,
        ...
        >
          <Icon
            ...
            containerStyle={Platform.OS === "ios" ? { marginTop: -7, width: 25, marginLeft: -6 } : { width: 25, marginLeft: -6 }}
